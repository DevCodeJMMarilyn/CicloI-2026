...
-- =========================================
-- INSERTAR FECHAS EN TABLA TIEMPO (MYSQL)
-- =========================================

INSERT INTO Tiempo (id_tiempo, fecha, dia, mes, mes_nombre, trimestre, año)
SELECT 
...
FROM (
    SELECT DATE('2024-01-01') + INTERVAL n DAY AS fecha
    FROM (
